...
const COPY = {
  en: {
    ...
    successPaidBody: 'Payment received. You are paid — tap See receipt if you need it.',
    paidBadge: 'PAID',
    seeReceipt: 'See receipt',
    hideReceipt: 'Hide receipt',
    addOnServiceToday: 'Add-on service today',
    noAddOnService: 'No extra service today.',
    guests: 'Guests',
    guest: 'Guest',
    yourBoat: 'Your boat',
    boat: 'Boat',
    ...
    chooseGuestToEdit: 'Whose details do you want to edit?',
  ...
  hi: {
    ...
    successPaidBody: 'भुगतान मिल गया। आपका भुगतान पूरा है — रसीद के लिए See receipt दबाएँ।',
    paidBadge: 'PAID',
    seeReceipt: 'रसीद देखें',
    hideReceipt: 'रसीद छिपाएँ',
    addOnServiceToday: 'आज की अतिरिक्त सेवा',
    noAddOnService: 'आज कोई अतिरिक्त सेवा नहीं।',
    guests: 'अतिथि',
    guest: 'अतिथि',
    yourBoat: 'आपकी नाव',
    boat: 'नाव',
    ...
    chooseGuestToEdit: 'किसकी जानकारी संपादित करनी है?',
